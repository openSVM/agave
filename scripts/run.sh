...
export RUST_LOG=${RUST_LOG:-solana=info,uwuave=info,solana_runtime::message_processor=debug} # if RUST_LOG is unset, default to info
...
# shellcheck disable=SC2086
uwuave-validator "${args[@]}" $SOLANA_RUN_SH_VALIDATOR_ARGS &
validator=$!
