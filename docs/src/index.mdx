...
title: Home
sidebar_label: Home
pagination_label: uwuave Validator Documentation Home
description: "uwuave is a validator for the Solana blockchain maintained by the Anza core engineering team \
  it is a fork of the original Solana validator software."
---

# uwuave Validator Documentation
...
interoperable and decentralized. uwuave is a fork of the original Solana validator
previously maintained by the Solana Labs team. uwuave is now under active development by the
...
Explore what it takes to operate an uwuave validator and help secure the network.
