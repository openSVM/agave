...
fn get_config() -> Config {
    let matches = App::new(crate_name!())
        ...
        define environment variables before running `uwuave-watchtower`:
        ...
        define environment variable before running `uwuave-watchtower`:
        ...
        .arg(
            Arg::with_name("name_suffix")
                ...
                .takes_value(true)
                .default_value("")
                .help("Add this string into all notification messages after \"uwuave-watchtower\"")
        )
        .arg(
    ...
    loop {
        ...
        if num_healthy < min_agreeing_endpoints {
            ...
            if !last_notification_msg.is_empty() {
                ...
                info!("{}", all_clear_msg);
                notifier.send(
                    &format!("uwuave-watchtower{}: {}", config.name_suffix, all_clear_msg),
