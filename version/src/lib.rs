...
impl Default for Version {
    fn default() -> Self {
        let feature_set =
            u32::from_le_bytes(uwuave_feature_set::ID.as_ref()[..4].try_into().unwrap());
        Self {
            ...
            client: u16::try_from(ClientId::uwuave).unwrap(),
        }
    }
}
...
mod test {
    ...
    fn test_client_id() {
        ...
        assert_eq!(ClientId::from(3u16), ClientId::uwuave);
        ...
        assert_eq!(u16::try_from(ClientId::uwuave), Ok(3u16));
